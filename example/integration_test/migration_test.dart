...
Future<void> _migrateWithDir(Directory dir) async {
  ...
  if (!flutter_downloader.FlutterDownloader.initialized) {
    await flutter_downloader.FlutterDownloader.initialize(debug: true);
  }
  ...
  final fdlTaskId = await flutter_downloader.FlutterDownloader.enqueue(
      url: workingUrl,
